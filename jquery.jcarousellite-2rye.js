 ...
 *
 * Modifications by 2rye include setting the 'visible' set of elements in the data section.
 * 
 *   $('.carousel').jCarouselLite(myparams);
 *   var visibleDomElements = $('.carousel').data().visibleElements;
 *
 */
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.
      ...
      if(o.btnPrev) {
        $(o.btnPrev).click(function() {
          $(_that).trigger('goPrev');
        });
      }

      if(o.btnNext) {
        $(o.btnNext).click(function() {
          $(_that).trigger('goNext');
        });
      }
      ...
      function go(to) {
        if(!running) {
          ...
          running = true;
          $(_that).data('position', {last:to+o.visible - 1, first:to});
